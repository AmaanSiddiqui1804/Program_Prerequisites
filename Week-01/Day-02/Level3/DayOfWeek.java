...
and so forth. For output print 0 for Sunday, 1 for Monday, 2 for Tuesday, and so forth. Use the following formulas, 
...
public class Main{
    ...
    public static void main(String[] args){
        ...
        // Calculating intermediate values for the formula
        int y0 = y - (14 - m) / 12;
